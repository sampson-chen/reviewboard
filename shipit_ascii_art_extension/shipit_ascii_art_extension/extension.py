# shipit_ascii_art_extension Extension for Review Board.
...
class AsciiArtURLHook(URLHook):
    def __init__(self, extension, *args, **kwargs):
        pattern = patterns('', (r'^shipit_ascii_art_extension/',
                            include('shipit_ascii_art_extension.urls')))
...
class AsciiArtDashboardHook(DashboardHook):
    def __init__(self, extension, *args, **kwargs):
        entries = [{
            ...
            'url': settings.SITE_ROOT + 'shipit_ascii_art_extension/',
        }]
